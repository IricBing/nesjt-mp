 ...
 */
export const MP_AUTH_URL = 'https://api.weixin.qq.com/sns/jscode2session';
 ...
 */
export const IMAGE_SECURITY_CHECK_URL = 'https://api.weixin.qq.com/wxa/img_sec_check';
 ...
 */
export const MESSAGE_SECURITY_CHECK_URL = 'https://api.weixin.qq.com/wxa/msg_sec_check';

/**
 * 获取小程序全局唯一后台接口调用凭据 access_token
 * 文档详见：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/access-token/auth.getAccessToken.html
 */
export const GET_ACCESS_TOKEN_URL = 'https://api.weixin.qq.com/cgi-bin/token';
